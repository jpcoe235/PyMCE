...
class initdyn():
    ...
    def __init__(self):
        ...
        self._gamma = np.asarray([22.7,22.7,22.7,22.7,22.7,22.7,4.7,4.7,4.7,4.7,4.7,4.7,4.7,4.7,4.7,4.7,4.7,4.7, 4.7, 4.7, 4.7, 4.7,4.7, 4.7, 4.7, 4.7,4.7 ])  # Gamma var, width of the gaussians
