...
statepairs=ieig+((ieig-1)*ieig)/2   ! now include equal states as these are the 2RDMs and means we can do them all at once so don't have to check difference between dets again
